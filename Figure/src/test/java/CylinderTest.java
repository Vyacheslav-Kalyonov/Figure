...
public class CylinderTest {
    ...
    private static Cylinder figureTestPassed;
    private static Cylinder figureTestFailed;
    ...
    public static void addElement() {
        ...
        figureTestPassed = new Cylinder(pointTestPassed);
        figureTestFailed = new Cylinder(pointTestFailed);
    }
    ...
    public void figureAreaTest() {
        ...
        assertEquals("The figure area 12.57", outputStreamCaptor.toString().trim());
    }
