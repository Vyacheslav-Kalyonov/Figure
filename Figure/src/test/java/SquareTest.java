...
public class SquareTest {
    ...
    private static Square figureTestPassed;
    private static Square figureTestFailed;
    ...
    public static void addElement() {
        ...
        figureTestPassed = new Square(pointTestPassed);
        figureTestFailed = new Square(pointTestFailed);
    }
