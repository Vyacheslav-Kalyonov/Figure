...
public class SphereTest {
    ...
    private static Sphere figureTestPassed;
    private static Sphere figureTestFailed;
    ...
    public static void addElement() {
        ...
        figureTestPassed = new Sphere(pointTestPassed);
        figureTestFailed = new Sphere(pointTestFailed);
    }
